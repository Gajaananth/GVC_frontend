...
-- ============================================================
-- FIXED DEPOSITS (sample)
-- ============================================================

INSERT INTO fixed_deposits (id, fd_code, customer_id, principal_amount, interest_rate, term_months, maturity_date, total_interest, total_maturity_amount, status, is_blocked, payout_method, created_by)
VALUES
(
...
(
  ...
  'FD-20260525-00003',
  'c0000002-0002-0002-0002-000000000002',
  150000.00, 7.5, 6, '2026-11-25', 5625.00, 155625.00,
  'matured', FALSE, 'bank_transfer',
  'a1b2c3d4-0001-0001-0001-000000000001'
);
