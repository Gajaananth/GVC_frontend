...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <div className={`fixed inset-y-0 left-0 transform ${isOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 transition-transform duration-300 ease-in-out z-[110] w-72 lg:w-64 max-w-full bg-forest text-white flex flex-col h-screen shadow-2xl`}>
