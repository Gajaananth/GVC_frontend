...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 flex flex-col min-h-screen max-w-7xl mx-auto px-0 sm:px-4 min-w-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6 flex-1 min-h-0 mt-4 sm:mt-6">
        ...
        <div className="lg:col-span-2 glass-card flex flex-col flex-1 min-h-0 overflow-hidden">
        ...
        {/* Action Panel */}
          <div className="glass-card flex flex-col flex-1 min-h-0 p-4 sm:p-6 gap-4 sm:gap-6 max-h-none lg:max-h-full overflow-y-auto">
